...
func TestDebugSessionStatusPreservesResourceIdentities(t *testing.T) {
	status := breakglassv1alpha1.DebugSessionStatus{
		...
		DeployedResources:           []breakglassv1alpha1.DeployedResourceRef{{APIVersion: "v1", Kind: "Pod", Name: "pod", Namespace: "ns", UID: "deployed", Source: "debug-pod"}},
		AllowedPods:                 []breakglassv1alpha1.AllowedPodRef{{Name: "pod", Namespace: "ns", UID: "allowed"}},
		AuxiliaryResourceStatuses:   []breakglassv1alpha1.AuxiliaryResourceStatus{{UID: "auxiliary", AdditionalResources: []breakglassv1alpha1.AdditionalResourceRef{{UID: "additional"}}}},
		PodTemplateResourceStatuses: []breakglassv1alpha1.PodTemplateResourceStatus{{UID: "pod-template"}},
